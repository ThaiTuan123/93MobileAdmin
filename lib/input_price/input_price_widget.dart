...
import 'input_price_model.dart';
export 'input_price_model.dart';

class InputPriceWidget extends StatefulWidget {
  const InputPriceWidget({super.key});
...
class _InputPriceWidgetState extends State<InputPriceWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InputPriceModel());
